...
BEGIN
	INSERT INTO [dbo].[gemini_customfielddefinitions] ([customfieldname], [screenorder], [screenlabel], [screendescription], [screentooltip], [maxlen], [canmultiselect], [regularexp], [customfieldtype], [lookupname], [lookupvaluefield], [lookuptextfield], [lookupsortfield], [projectidfilter], [created], [showinline], [lookupdata], [maxvalue], [minvalue], [listlimiter], [usedin], [templateid], [usestaticdata], [canfilter], [cascadinglookupvaluefield], [cascadingparentfield], [allownoselection], [autocomplete]) VALUES (N'Run Status', 0, N'Run Status', N'', N'Run Status', 0, 0, N'', N'R', N'', N'', N'', N'', 0, '2013-09-12T11:05:01.670', 1, N'', NULL, NULL, N'', 0, 19, 0, 0, N'', 0, 0, 0)
