        ...
        "_fnMouseDown": function (e, nTh)
        {
            ...
            this.s.mouse.targetIndex);
                ...
                if (this.s.fixed !== 0) {
                    ...
                    //this.s.aoTargets.splice(0, 1);
                    /*this.s.aoTargets.splice(this.s.fixed, 1);*/
                    //this.s.aoTargets.splice(0, 1);
                }
        ...
        */
        "_fnMouseUp": function (e)
        {
            ...
            if (this.dom.drag !== null)
            {
                ...
                {
                    this.s.init.fnColReorderCallback(this.s.mouse.fromIndex, this.s.mouse.toIndex);
                }
            }
        },
