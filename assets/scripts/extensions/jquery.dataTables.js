...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnGatherData( oSettings )
		{
			...
			for ( iColumn=0, iColumns=oSettings.aoColumns.length ; iColumn<iColumns ; iColumn++ )
			{
                ...
                if(oCol.sGeminiId == '')
                {
                    oCol.sGeminiId = $(oCol.nTh).data('id');
                }
		...
		function _fnBuildHead( oSettings )
		{
			...
			if ( oSettings.oFeatures.bSort )
			{
				for ( i=0 ; i<oSettings.aoColumns.length ; i++ )
				{
					...
					{
                        _fnSortAttachListener( oSettings, oSettings.aoColumns[i].nTh, i, oSettings.fnSortCallback );
					}
					else
					{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
            ...
            // HSK put $() around nFilter in next line...
		...
		function _fnFilterComplete ( oSettings, oInput, iForce )
		{
			...
			if (oInput.sSearch != null && oInput.sSearch != undefined && oInput.sSearch.length > 0) {
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			{
			    /* Empty record set */
			    //SAAR We don't want to display no data in the footer (nav bar)
		...
		function _fnSortAttachListener ( oSettings, nNode, iDataIndex, fnCallback )
		{
			_fnBindAction( nNode, {}, function (e) {
				...
				var fnInnerSorting = function () {
					...
					/* Run the sort */
                    if(oSettings.fnSortCallback == null) _fnSort( oSettings );
				}; /* /fnInnerSorting */
        ...
        this.fnSetSort= function(data) {
            var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
            oSettings.aaSorting = [];

            var i = 0;
            for(i=0; i< data.length; i++) {
                oSettings.aaSorting.push([data[i][0], data[i][1] == 0 ? "asc" : "desc", data[i][1]]);
            }
		...
		return this.each(function() {
            ...
            _fnMap( oSettings, oInit, "fnSortCallback" );
	...
	DataTable.defaults = {
        ...
        fnSortCallback: null//gemini_filter.sortColumn
	};
