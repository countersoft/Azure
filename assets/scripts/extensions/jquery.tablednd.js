    ...
    mousemove: function(ev) {
        ...
        if (y != jQuery.tableDnD.oldY) {
            ...
            if (currentRow) {
                ...
                if (movingDown && jQuery.tableDnD.dragObject != currentRow && $(currentRow).children('th').length == 0) {
                    jQuery.tableDnD.dragObject.parentNode.insertBefore(jQuery.tableDnD.dragObject, currentRow.nextSibling);
                } else if (!movingDown && jQuery.tableDnD.dragObject != currentRow && $(currentRow).children('th').length == 0) {
