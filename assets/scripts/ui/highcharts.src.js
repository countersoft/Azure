...
Point.prototype = {
	...
	applyOptions: function (options, x) {
		...
		if (optionsType === 'number' || options === null) {
			point.y = options;
		} else if (optionsType!=='undefined' && typeof options[0] === 'number') { // two-dimentional array
			point.x = options[0];
			point.y = options[1];
		...
		} else if (optionsType!=='undefined' && typeof options[0] === 'string') { // categorized data with name in first position
